...
//        FileOutputStream fileOut = new FileOutputStream("c://alaa/poi-generated-file.xlsx");
...
//        workbook.close();
    ...
    private static void modifyExistingWorkbook() throws InvalidFormatException, IOException {
        ...
        Workbook workbook = WorkbookFactory.create(new File("c://alaa/poi-generated-file.xlsx"));
        ...
        cell.setCellValue("Updated Value 2222222");

        // Write the output to the file
        FileOutputStream fileOut = new FileOutputStream("c://alaa/existing-spreadsheet.xlsx");
        workbook.write(fileOut);
        fileOut.close();
